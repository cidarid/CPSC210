...
public class GamePanel extends JPanel {
    ...
    private void drawPaddle(Graphics g) {
        ...
        g.fillRect(t.getX() - Puddle.DIMENSION1 / 2, Puddle.Y_POS - Puddle.DIMENSION2 / 2, Puddle.DIMENSION1,
                Puddle.DIMENSION2);
        g.setColor(savedCol);
    }
    ...
    private void drawBall(Graphics g) {
        ...
        g.fillOval(b.getX1() - Ball.SIZE / 2, b.getY1() - Ball.SIZE / 2, Ball.SIZE, Ball.SIZE);
        g.setColor(savedCol);
    }
